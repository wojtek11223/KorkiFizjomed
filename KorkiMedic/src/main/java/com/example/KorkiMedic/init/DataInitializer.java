    ...
    public void run(String... args) throws Exception {
        if (userRepository.count() == 0) {
            ...
            if (appointmentRepository.count() == 0) {
                ...
                Appointment appointment1 = new Appointment(null, patient, doctor1, service1, tomorrowDate,100, "Routine checkup", null, null);
                calendar.add(Calendar.DAY_OF_YEAR, 1);
                ...
                Appointment appointment2 = new Appointment(null, patient, doctor2, service2, tomorrowDate, 0, "Scheduled surgery", null, null);
               ...
               userRole = new HashSet<>();
                ...
                User doctor3 = new User(null, "Agnieszka", "Kwiatkowska", "agnieszka.kwiatkowska@example.com", "888888888", LocalDate.of(1982, 4, 5), 0,
                        Set.of(Role.DOCTOR), Set.of(dermatology), Set.of(service4), null, null, passwordEncoder.encode("haslo123"));
                User doctor4 = new User(null, "Tomasz", "Lewandowski", "tomasz.lewandowski@example.com", "999999999", LocalDate.of(1978, 9, 20), 0,
                        Set.of(Role.DOCTOR), Set.of(pediatrics, psychiatry), Set.of(service5), null, null, passwordEncoder.encode("haslo123"));
                ...
                Appointment appointment3 = new Appointment(null, patient, doctor3, service4, futureDate,300, "Konsultacja dermatologiczna", null, null);
                calendar.add(Calendar.DAY_OF_YEAR, 1);
                ...
                Appointment appointment4 = new Appointment(null, patient, doctor4, service5, futureDate,200, "Terapia psychologiczna", null, null);
